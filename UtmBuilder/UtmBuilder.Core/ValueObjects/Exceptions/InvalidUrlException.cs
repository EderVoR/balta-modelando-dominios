...
namespace UtmBuilder.Core.ValueObjects.Exceptions
{
	public partial class InvalidUrlException : Exception
	{
		...
		public static void ThrowIfInvalid(string adress, string message = DefaultErrorMessage)
		{
			if(string.IsNullOrEmpty(adress))
				throw new InvalidUrlException(message);

			if (!UrlRegexPartial().IsMatch(adress))
		...
		private static partial Regex UrlRegexPartial();
	}
}
